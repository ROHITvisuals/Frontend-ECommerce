...
function LoginSignUp() {
  ...
  let { Login , isAuthenticated , Register ,
    Error_message , message , setMessage , setError_message , loading  } = context;
  ...
  }, [ history, isAuthenticated , redirect , location ])
...
//  Register Started from here
  ...
  const registerDataChange = (e) => {
    if ((e.target.name === "avatar")  ) {
      ...
      // console.log("inside fileOnchange");
